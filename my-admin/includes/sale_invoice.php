...
if($_GET["id"]){
    ...
    echo '<tr>
            <th colspan="4" style="text-align:right; padding-right:10px;">Sub Total </th>
            <td>'.$subTotal.'</td>
        </tr>
        <tr>
            <th colspan="4" style="text-align:right; padding-right:10px;">Tax </th>
            <td>'.$etc.'</td>
        </tr>
        <tr>
            <th colspan="4" style="text-align:right; padding-right:10px;">Discount </th>
            <td>'.$discount.'</td>
        </tr>
        <tr>
            <th colspan="4" style="text-align:right; padding-right:10px;">Grand Total </th>
            <td>'.$grandTotal.'</td>
        </tr>
        <tr>
            <th colspan="4" style="text-align:right; padding-right:10px;">Paid </th>
            <td>'.$finalPayment.'</td>
        </tr>
        <tr>
            <th colspan="4" style="text-align:right; padding-right:10px;">Balance </th>
            <td>'.$balance.'</td>
        </tr>
        </table>';
