              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <?php 
                  ...
                  if(isset($_POST['filter'])){
                    ...
                    $query = mysqli_query($con,"SELECT * FROM sales WHERE cat = 'sale' AND date >= '$startDate' AND date <= '$endDate' ORDER BY id DESC");
                  }else{
                    $query = mysqli_query($con,"SELECT * FROM sales WHERE cat = 'sale' ORDER BY id DESC");
                  }
                  ...
                  while($result = mysqli_fetch_array($query)){
                    ...
                    $button = '<div class="dropdown">
                      ...
                      <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                        <a href="includes/sale_invoice.php?&id='.$id.'" type="button" name="id" class="dropdown-item"> <i class="fa fa-print"></i> Print Invoice </a>
