...
$fianlVal = ((($paid + $paymemts) - $expenses) - $bank);
?>
...
<section class="content">
        ...
        <div class="row">
          ...
          <div class="col-md-4">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form id="add_bank_statement_form" action="includes/add_bank_statement_process.php" method="post" enctype="multipart/form-data">
                <div class="card-body">
                  <div class="form-group">
                    <label for="date">Date</label>
                    <input type="date" class="form-control form-control-sm" id="date" name="date" value="<?php echo $today; ?>" readonly>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="number" class="form-control form-control-sm" id="amount" name="amount" min="0" max="<?php echo $fianlVal; ?>" placeholder="Enter Amount" required>
    ...
    <!-- DataTable... -->
        <div class="card card-primary">
            <div class="card-header">
              <h3 class="card-title">Manage Bank Amounts</h3>
            </div>
            <!-- /.card-header -->
              ...
              <table id="example1" class="table table-bordered table-striped" style="text-align:center;">
                ...
                <?php 
                    ...
                    $query = mysqli_query($con,"SELECT * FROM bank ORDER BY id DESC");

                  $x = 1;
                  include_once('database/connection.php');
                  while($result = mysqli_fetch_array($query)){
                    $id = $result['id'];
                    $button = '<button type="button" class="btn btn-danger" onclick="delete_bank_statement('.$id.')" data-toggle="modal" data-target="#delete_bank_statement_modal">Delete</button>';
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <form id="delete_bank_statement" action="includes/delete_bank_statement_process.php" method="post">
          <input type="hidden" id="delete_bank_statement_id" name="delete_bank_statement_id">
      </div>
      <div class="card-body">
