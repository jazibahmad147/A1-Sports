   ...
   <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Customers Dues</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="dashboard.php">Home</a></li>
              <li class="breadcrumb-item active">Customers Dues</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    ...
    <!-- DataTable... -->
        <div class="card card-primary">
            <div class="card-header">
              <h3 class="card-title">Customers Dues</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
              <div class="row">
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <?php 
                  ...
                  if(isset($_POST['filter'])){
                    ...
                    $query = mysqli_query($con,"SELECT * FROM sales WHERE balance > '0' date BETWEEN '$startDate' AND '$endDate' ORDER BY id DESC");
                  }else{
                    $query = mysqli_query($con,"SELECT * FROM sales WHERE balance > '0' ORDER BY id DESC");
                  }
                  ...
                  while($result = mysqli_fetch_array($query)){
                    ...
                    $button = '<div class="dropdown">
                      ...
                      <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                        <a href="#?&id='.$id.'" type="button" name="id" onclick="print_barcode_gold_pathor_stock_item('.$id.')" class="dropdown-item" data-toggle="modal" data-target="#barcode_gold_pathor_stock_item_modal"> <i class="fa fa-print"></i> Print Invoice </a>
                    ...
                    $x++;
                    $grandTotalSum += $result['grandTotal'];
                    $paidSum += $finalPayment;
                    $balanceSum += $finalBalance;
                  }
                ?>
                <tr>
                    <td></td>
                    <td colspan="3" style="text-align:center; font-weight:bold;">Total</td>
                    <td><?php echo $grandTotalSum; ?></td>
                    <td><?php echo $paidSum; ?></td>
                    <td><?php echo $finalBalance; ?></td>
                    <td></td>
                </tr>
                </tbody>
              </table>
