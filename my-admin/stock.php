...
<section class="content">
      ...
      <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form id="add_stock_form" action="includes/add_stock_process.php" method="post" enctype="multipart/form-data">
                <div class="card-body">
                <div class="row">
                  <div class="col-md-2">
                  ...
                  <div class="col-md-2">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control form-control-sm" id="name" name="name" placeholder="Enter Item Name" required>
                    </div>
                  </div>
                  <div class="col-md-1">
                    <div class="form-group">
                  ...
                  <div class="col-md-2">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control form-control-sm" id="description" name="description" placeholder="Enter Item Description" required>
                    </div>
                  </div>
                  <div class="col-md-1">
                    <div class="form-group">
                      <label for="qty">Quantity</label>
                      <input type="number" class="form-control form-control-sm" id="qty" name="qty" placeholder="Enter Quantity" required>
                    </div>
                  </div>
                  <div class="col-md-2">
                    <div class="form-group">
                      <label for="whole_sale_price">Whole Sale Price</label>
                      <input type="text" class="form-control form-control-sm" id="whole_sale_price" name="whole_sale_price" placeholder="Enter Whole Sale Price" required>
                    </div>
                  </div>
                  <div class="col-md-1">
                    <div class="form-group">
                      <label for="retail_price">Retail</label>
                      <input type="text" class="form-control form-control-sm" id="retail_price" name="retail_price" placeholder="Enter Retail Price" required>
                    </div>
                  </div>
                  <div class="col-md-2">
                    <div class="form-group">
    ...
    <!-- DataTable... -->
        <div class="card card-primary">
            <div class="card-header">
              <h3 class="card-title">Low Stock Table</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
              <div class="row">
                ...
                <div class="form-group">
                  <form action="" method="post">
                    <label for="company">Filter By Category</label>
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <?php 
                  ...
                  if(isset($_POST['categorySubmit'])){
                    ...
                    $query = mysqli_query($con,"SELECT * FROM stock WHERE qty < '5' AND category = '$selectedCategory' ORDER BY date DESC");
                  }else if(isset($_POST['companySubmit'])){
                    $selectedCompany = $_POST['company'];
                    $query = mysqli_query($con,"SELECT * FROM stock WHERE qty < '5' AND company = '$selectedCompany' ORDER BY date DESC");
                  }else{
                    $query = mysqli_query($con,"SELECT * FROM stock WHERE qty < '5' ORDER BY date DESC");
                  }
